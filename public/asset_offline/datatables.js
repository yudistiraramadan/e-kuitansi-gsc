...
!(function (n) {
                      ...
                      if ("table" != this.nodeName.toLowerCase())
                          ...
                          for (
                              ...
                              if (
                                  ...
                                  var E = (void 0 !== n.bRetrieve ? n : e)
                                          .bRetrieve,
                                      k = (void 0 !== n.bDestroy ? n : e)
                                          .bDestroy;
                          ...
                          (null !== t && "" !== t) ||
                              ((t = "DataTables_Table_" + $.ext._unique++),
                              (this.id = t));
                          var u = V.extend(!0, {}, $.models.oSettings, {
                              ...
                              c =
                                  ($.__browser ||
                                      ...
                                      (O = p.children()),
                                      (P.barWidth =
                                          p[0].offsetWidth - p[0].clientWidth),
                                      (P.bScrollbarLeft =
                                          1 !== Math.round(O.offset().left)),
                                      j.remove()),
                          ...
                          if (w)
                              for (g = 0, v = w.length; g < v; g++) _(g, w[g]);
                          var L,
                              F,
                              N,
                              j,
                              ...
                              O = function () {
                                  ...
                                  var e = o.children("caption"),
                                      ...
                                      e =
                                          (0 === e.length &&
                                              (e =
                                                  V("<tbody/>").insertAfter(h)),
                                          (u.nTBody = e[0]),
                                          o.children("tfoot"));
                                  if (
                                      (0 === e.length &&
                                          (e = V("<tfoot/>").appendTo(o)),
                                      (u.nTFoot = e[0]),
                ...
                : ((f = function (t, e, n) {
                      ...
                      if ("" !== n)
                          for (var i = ft(n), l = 0, s = i.length; l < s; l++) {
                              if (
                                  ((d = i[l].match(dt)), (a = i[l].match(p)), d)
                              ) {
                                  if (
                                      ((i[l] = i[l].replace(dt, "")),
                                      "" !== i[l] && (t = t[i[l]]),
            ...
            for (
                ...
                (i = t.aoColumns[l]),
                    (o = (u = !n || !a[l])
                        ...
                        : a[l]) || Z(t, 0, "Incorrect column count", 18),
                    (o._DT_CellIndex = { row: e, column: l }),
                    f.push(o);
                var p = mt(t, e);
                (!u &&
                    ((!i.mRender && i.mData === l) ||
                        (V.isPlainObject(i.mData) &&
                            i.mData._ === l + ".display"))) ||
                    ct(o, p[l]),
                    i.bVisible && u
                        ? r.appendChild(o)
    ...
    function Dt(t, e) {
        ...
        if (o) {
            if (
                ...
                1 ===
                    (n = (n = V("tr", o)).length ? n : V("<tr/>").appendTo(o))
                        .length
            )
        ...
        if (
            ...
            if (0 !== o.length)
                for (
                    ...
                    tt(t, "aoRowCallback", null, [g, p._aData, a, f, h]),
                        n.push(g),
                        a++;
                }
            else n[0] = Tt(t);
                ...
                a =
                    (V.each(e, function (t, e) {
                        if (null !== e) {
                            ...
                            Array.isArray(a[n].contents) ||
                                (a[n].contents = [a[n].contents]);
                        }
                    }),
                    Object.keys(i)
                        .map(function (t) {
    ...
    function Ct(e) {
        ...
        n.oFeatures.bProcessing &&
            ...
            v
                ? a.prependTo("div.dt-scroll", n.nTableWrapper)
                : a.insertBefore(t),
        ...
        var r,
            ...
            l =
                    ...
                    delete o.data),
                {
                    ...
                    error: function (t, e) {
                        -1 ===
                            tt(n, null, "xhr", [n, null, n.jqXHR], !0).indexOf(
                                !0
                            ) &&
                            ("parsererror" == e
                    ...
                    for (o = [], a = 0, r = u.length; a < r; a++)
                        u[a].bSearchable
                            ...
                            i.indexOf &&
                                -1 !== i.indexOf("&") &&
                                ((Rt.innerHTML = i),
                                (i = Ot ? Rt.textContent : Rt.innerText)),
    ...
    function zt(t, e, n) {
        ...
        return (
            void 0 === e && ((t.bSorted = !0), tt(t, null, "order", [t, c])), u
        );
    }
    function Yt(t) {
        var e,
        ...
        if (l.bSort && l.bSortClasses) {
            for (e = 0, n = r.length; e < n; e++)
                (a = r[e].src),
                    V(f(t.aoData, "anCells", a)).removeClass(
                        o + (e < 2 ? e + 1 : 3)
                    );
            for (e = 0, n = i.length; e < n; e++)
                (a = i[e].src),
                    V(f(t.aoData, "anCells", a)).addClass(
                        o + (e < 2 ? e + 1 : 3)
                    );
        }
        t.aLastSort = i;
    ...
    function Jt(n, t, e) {
        ...
        if (t && t.time) {
            ...
            if (0 < l && t.time < +new Date() - 1e3 * l) n._bLoadingState = !1;
                ...
                -1 !==
                tt(n, "aoStateLoadParams", "stateLoadParams", [n, t]).indexOf(
                    !1
                )
            )
                n._bLoadingState = !1;
                ...
                if (
                    ...
                    void 0 !== t.search &&
                        V.extend(n.oPreviousSearch, t.search),
                    t.columns)
                ) {
                    for (a = 0, r = t.columns.length; a < r; a++) {
                        ...
                        void 0 !== s.visible &&
                            ...
                            void 0 !== s.search &&
                                V.extend(n.aoPreSearchCols[a], s.search);
                    }
                    i && i.columns.adjust();
                }
                (n._bLoadingState = !1),
                    tt(n, "aoStateLoaded", "stateLoaded", [n, t]);
            }
    ...
    function Z(t, e, n, a) {
        if (
            ...
            if ((t && tt(t, null, "dt-error", [t, a, n], !0), "alert" == e))
                alert(n);
            else {
        ...
        (U.register = e =
            function (t, e) {
                if (Array.isArray(t))
                    ...
                    for (
                        var r = t.split("."), o = ne, i = 0, l = r.length;
                        i < l;
                        i++
                    ) {
                        var s,
        ...
        t &&
            ...
            "ssp" == et(r)
                ...
                : (w(r, !0),
                  ...
                  At(r, {}, function (t) {
                      pt(r);
                      for (var e = Lt(r, t), n = 0, a = e.length; n < a; n++)
                          Y(r, e[n]);
                      s(r, o), kt(r), w(r, !1);
                  }));
    }
        ...
        e("ajax.url()", function (e) {
            ...
            return void 0 === e
                ? 0 === t.length
                    ? void 0
                    : ((t = t[0]),
                      V.isPlainObject(t.ajax) ? t.ajax.url : t.ajax)
                : this.iterator("table", function (t) {
            ...
            if (a._details) {
                (a._detailsShow = e)
                    ? (a._details.insertAfter(a.nTr),
                      V(a.nTr).addClass("dt-hasChild"))
                    : (a._details.detach(),
                      V(a.nTr).removeClass("dt-hasChild")),
            ...
            ($.isDataTable = function (t) {
                ...
                return (
                    ...
                    (V.each($.settings, function (t, e) {
                        var n = e.nScrollHead
                                ? V("table", e.nScrollHead)[0]
                                : null,
                            a = e.nScrollFoot
                                ? V("table", e.nScrollFoot)[0]
                                : null;
                ...
                _: function (t, e, n, a, r) {
                    ...
                    return (
                        ...
                        r && o.push(t.disabled),
                        {
                            display: (a =
                                "ellipsis" === e
                                    ? V('<span class="ellipsis"></span>').html(
                                          n
                                      )[0]
                                    : V("<button>", {
                                          class: o.join(" "),
        ...
        $.feature.register(
            ...
            function (t, e) {
                    ...
                    !(function t(e, n, a) {
                        ...
                        h.length &&
                            ...
                            t(
                                e,
                                n,
                                V.extend({}, a, { numbers: a.numbers - 2 })
                            );
                    })(t, a, e);
                }
                ...
                return (
                    ...
                    V(t.nTable).on("column-sizing.dt.DT", n),
                    a
                );
            },
            "p"
